    ...
    <div class="d-flex justify-content-center" style="width:100%; height:auto">
        ...
        <div class="row justify-content-center mb-4" style="width:80%; height:auto;">
            ...
            <div class="container" style="width:100%">
                {{-- Top div --}}
                <div class="mb-3 p-3 px-0 d-flex justify-content-between align-items-center"
                    style="width:100%;">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="{{ route('admin.display.package', ['filter' => 'minOrder100']) }}">> 100 pax</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.display.package', ['filter' => 'minOrder200']) }}">> 200 pax</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.display.package', ['filter' => 'minOrder500']) }}">> 500 pax</a></li>
                            <hr>
                            <li ><span class="ms-3">Price</span></li>
                            <li><a class="dropdown-item" href="{{ route('admin.display.package', ['filter' => 'priceBelow10']) }}">< RM10.00 per pax</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.display.package', ['filter' => 'priceBelow20']) }}">< RM20.00 per pax</a></li>
                            <li><a class="dropdown-item" href="{{ route('admin.display.package', ['filter' => 'priceBelow30']) }}">< RM30.00 per pax</a></li>
                        </ul>
                    </div>
